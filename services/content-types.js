...
exports.getContentTypeByMachineName = (httpClient, machineName) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    if (!machineName || machineName.length === 0) {
        throw new TypeError("Expected parameter machineName");
    }
    try {
        const response = yield httpClient.get(`content-types/${machineName}`);
